"""
Django settings for textile_assistant project.
...
SECRET_KEY = 'django-insecure-_!6xfvrh!0wecf_4=lxw)w=^x2)vb*0puhm+v&y^lfu$sl0v8z'
...
ROOT_URLCONF = 'textile_assistant.urls'
...
WSGI_APPLICATION = 'textile_assistant.wsgi.application'
